...
import {
  ...
  CountriesNamesContainer,
  VisitedCountriesContainer,
  NoCountriesTextContainer,
  NoCountriesText,
  ...
  render() {
    ...
    return (
      <AppContainer>
        ...
        <CountriesNamesContainer>
          <Headings>Visited Countries</Headings>
            ...
            <VisitedCountriesContainer>
              {visitedCountriesList.map(each => (
                <VisitedCountryItem
                  key={each.id}
                  details={each}
                  clickedRemoveButton={this.clickedRemoveButton}
                />
              ))}
            </VisitedCountriesContainer>
          ) : (
